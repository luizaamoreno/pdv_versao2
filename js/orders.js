...
import { cart, discountPercentage, updateCartDisplay, saveCart, clearCart } from './cart.js';
...
document.getElementById('finish-payment').addEventListener('click', finalizeSale);
